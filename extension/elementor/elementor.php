...
final class law_plugin_elementor_widgets {
    ...
    public function init_category() {
        ...
        Plugin::instance()->elements_manager->add_category(
            'law_widgets',
            [
                'title' => esc_html__( 'Basic Theme Widgets', 'law' ),
                'icon'  => 'icon-goes-here'
            ]
        );
    ...
    public function init_script() {
        wp_register_script( 'law-elementor-custom', get_theme_file_uri( '/js/elementor-custom.js' ), array(), '1.0.0', true );
    }

}

law_plugin_elementor_widgets::instance();
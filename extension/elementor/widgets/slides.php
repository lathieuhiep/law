...
class law_widget_slides extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Slides Theme', 'law' );
    }
    ...
    protected function _register_controls() {
        ...
        $repeater->start_controls_tab( 'background', [ 'label' => esc_html__( 'Background', 'law' ) ] );

        $repeater->add_control(
            'slides_image',
            [
                'label'     =>  esc_html__( 'Image', 'law' ),
        ...
        $repeater->add_control(
            'background_size',
            [
                'label'     =>  esc_html__( 'Size', 'law' ),
                'type'      =>  Controls_Manager::SELECT,
                'default'   =>  'cover',
                'options'   =>  [
                    'cover'     =>  esc_html__( 'Cover', 'law' ),
                    'contain'   =>  esc_html__( 'Contain', 'law' ),
                    'auto'      =>  esc_html__( 'Auto', 'law' ),
                ],
                'selectors' => [
        ...
        $repeater->add_control(
            'background_overlay',
            [
                'label' => esc_html__( 'Background Overlay', 'law' ),
        ...
        $repeater->start_controls_tab( 'content', [ 'label' => esc_html__( 'Content', 'law' ) ] );

        $repeater->add_control(
            'heading',
            [
                'label' => esc_html__( 'Title & Description', 'law' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Slide Heading', 'law' ),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => esc_html__( 'Click edit button to change this text. Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'law' ),
                'show_label' => false,
            ]
        );
        ...
        $repeater->add_control(
            'button_text',
            [
                'label' => esc_html__( 'Button Text', 'law' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Click Here', 'law' ),
            ]
        );
	    ...
	    $repeater->add_control(
		    'show_content',
		    [
			    'label'         => esc_html__( 'Show Content', 'law' ),
			    'type'          => Controls_Manager::SWITCHER,
			    'label_on'      => esc_html__( 'Show', 'law' ),
			    'label_off'     => esc_html__( 'Hide', 'law' ),
			    'return_value'  => 'yes',
			    'default'       => 'yes',
		    ]
	    );
        ...
        $repeater->start_controls_tab( 'style', [ 'label' => esc_html__( 'Style', 'law' ) ] );

        $repeater->add_control(
            'custom_style',
            [
                'label' => esc_html__( 'Custom', 'law' ),
                'type' => Controls_Manager::SWITCHER,
                'description' => esc_html__( 'Set custom style that will only affect this specific slide.', 'law' ),
            ]
        );
        ...
        $repeater->add_control(
            'horizontal_position',
            [
                'label' => esc_html__( 'Horizontal Position', 'law' ),
        ...
        $repeater->add_control(
            'vertical_position',
            [
                'label' => esc_html__( 'Vertical Position', 'law' ),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'top' => [
                        'title' => esc_html__( 'Top', 'law' ),
                        'icon' => 'eicon-v-align-top',
                    ],
                    'middle' => [
                        'title' => esc_html__( 'Middle', 'law' ),
                        'icon' => 'eicon-v-align-middle',
                    ],
                    'bottom' => [
                        'title' => esc_html__( 'Bottom', 'law' ),
        ...
        $repeater->add_control(
            'text_align',
            [
                'label' => esc_html__( 'Text Align', 'law' ),
                'type' => Controls_Manager::CHOOSE,
                'label_block' => false,
                'options' => [
                    'left' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   =>  [
                    [
                        'heading' => esc_html__( 'Slider 1 Heading', 'law' ),
                        'description' => esc_html__( 'Click edit button to change this text. Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'law' ),
                        'button_text' => esc_html__( 'Click Here', 'law' ),
                        'link' => '#'
                    ],
                    [
                        'heading' => esc_html__( 'Slider 2 Heading', 'law' ),
                        'description' => esc_html__( 'Click edit button to change this text. Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'law' ),
                        'button_text' => esc_html__( 'Click Here', 'law' ),
                        'link' => '#'
                    ],
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Slider Options', 'law' ),
        ...
        $this->add_responsive_control(
            'content_max_width',
            [
                'label' => esc_html__( 'Content Width', 'law' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_control(
            'heading_color',
            [
                'label' => esc_html__( 'Text Color', 'law' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'button_border_width',
            [
                'label' => esc_html__( 'Border Width', 'law' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Border Radius', 'law' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->start_controls_tab( 'normal', [ 'label' => esc_html__( 'Normal', 'law' ) ] );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Background Color', 'law' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'button_border_color',
            [
                'label' => esc_html__( 'Border Color', 'law' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_tab( 'hover', [ 'label' => esc_html__( 'Hover', 'law' ) ] );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Navigation', 'law' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'conditions' => [
                    'relation' => 'or',
                    'terms' => [
        ...
        $this->add_control(
            'arrows_size',
            [
                'label' => esc_html__( 'Arrows Size', 'law' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 10,
        ...
        $this->add_control(
            'arrows_color',
            [
                'label' => esc_html__( 'Arrows Color', 'law' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'arrows_color_hover',
            [
                'label' => esc_html__( 'Arrows Color Hover', 'law' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'dots_size',
            [
                'label' => esc_html__( 'Dots Size', 'law' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 5,
        ...
        $this->add_control(
            'dots_color',
            [
                'label' => esc_html__( 'Dots Color', 'law' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'dots_color_hover',
            [
                'label' => esc_html__( 'Dots Color Hover', 'law' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                            ...
                            <div class="element-slides__item--content">
                                ...
                                <?php if ( !empty( $item['button_text'] ) ) : ?>
                                    <div class="element-slides__item--link">
                                        <?php if ( !empty( $law_slides_link['url'] ) ) : ?>
                                            <a href="<?php echo esc_url( $law_slides_link['url'] ); ?>" <?php echo ( $law_slides_link['is_external'] ? 'target="_blank"' : '' ); ?>>
...
Plugin::instance()->widgets_manager->register_widget_type( new law_widget_slides );
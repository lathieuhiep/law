...
class law_widget_post_carousel extends Widget_Base {
    ...
    public function get_name() {
        return 'law-post-carousel';
    }

    public function get_title() {
        return esc_html__( 'Posts Carousel', 'law' );
    }
...
Plugin::instance()->widgets_manager->register_widget_type( new law_widget_post_carousel );
...
class law_widget_post_grid extends Widget_Base {
    ...
    public function get_name() {
        return 'law-post-grid';
    }

    public function get_title() {
        return esc_html__( 'Posts Grid', 'law' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'column_number',
            [
                'label'     =>  esc_html__( 'Column', 'law' ),
                'type'      =>  Controls_Manager::SELECT,
                'default'   =>  3,
                'options'   =>  [
                    4   =>  esc_html__( '4 Column', 'law' ),
                    3   =>  esc_html__( '3 Column', 'law' ),
                    2   =>  esc_html__( '2 Column', 'law' ),
                    1   =>  esc_html__( '1 Column', 'law' ),
                ],
            ]
        );
        ...
        $this->add_control(
            'show_excerpt',
            [
                'label'     =>  esc_html__( 'Show excerpt', 'law' ),
                'type'      =>  Controls_Manager::CHOOSE,
                'options'   =>  [
                    '1' => [
                        'title' =>  esc_html__( 'Yes', 'law' ),
                        'icon'  =>  'fa fa-check',
                    ],
                    '0' => [
                        'title' =>  esc_html__( 'No', 'law' ),
                        'icon'  =>  'fa fa-ban',
                    ]
                ],
                'default' => '1'
        ...
        $this->add_control(
            'excerpt_length',
            [
                'label'     =>  esc_html__( 'Excerpt Words', 'law' ),
                'type'      =>  Controls_Manager::NUMBER,
                'default'   =>  '10',
                'condition' =>  [
                    'show_excerpt' => '1',
        ...
        $this->start_controls_section(
            'section_style_post',
            [
                'label' => esc_html__( 'Color & Typography', 'law' ),
        ...
        $this->add_control(
            'title_post_options',
            [
                'label'     =>  esc_html__( 'Title Post', 'law' ),
        ...
        $this->add_control(
            ...
            [
                'label'     =>  esc_html__( 'Color Hover', 'law' ),
                'type'      =>  Controls_Manager::COLOR,
                'default'   =>  '',
                'selectors' =>  [
        ...
        $this->add_control(
            ...
            [
                'label'     =>  esc_html__( 'Title Alignment', 'law' ),
                'type'      =>  Controls_Manager::CHOOSE,
                'options'   =>  [
                    'left'  =>  [
                    ...
                    'justify'=> [
                        'title' =>  esc_html__( 'Justified', 'law' ),
        ...
        $this->add_control(
            ...
            [
                'label'     =>  esc_html__( 'Excerpt Post', 'law' ),
                'type'      =>  Controls_Manager::HEADING,
                'separator' =>  'before',
            ]
        );
        ...
        $this->add_control(
            'excerpt_alignment',
            [
                'label'     =>  esc_html__( 'Excerpt Alignment', 'law' ),
                'type'      =>  Controls_Manager::CHOOSE,
                'options'   =>  [
                    'left'  =>  [
                        'title' =>  esc_html__( 'Left', 'law' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new law_widget_post_grid );
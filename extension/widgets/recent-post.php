...
class law_recent_post_widget extends WP_Widget {
    ...
    public function __construct() {
        ...
        $widget_ops = array(
            'classname'     =>  'law_recent_post_widget',
            'description'   =>  esc_html__( 'A widget show post', 'law' ),
        );

        parent::__construct( 'law_recent_post_widget', 'Basic Theme: Recent Post', $widget_ops );
    ...
    function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'select_cat' ) ); ?>">
                <?php esc_attr_e( 'Select Categories:', 'law' ); ?>
            </label>
            ...
            <select id="<?php echo esc_attr( $this->get_field_id( 'select_cat' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'select_cat' ) ) . '[]'; ?>" class="widefat" size="10" multiple>
                ...
                <option value="0" <?php echo ( in_array( 0, $select_cat ) ? 'selected="selected"' : '' ); ?>>
                    <?php esc_html_e( 'All Category', 'law' ); ?>
                </option>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>">
                <?php esc_html_e( 'Number of posts to show:', 'law' ); ?>
            </label>
...
// Register widget
function law_recent_post_widget_register() {
    register_widget( 'law_recent_post_widget' );
}

add_action( 'widgets_init', 'law_recent_post_widget_register' );